    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {reports.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 font-medium">No reports waiting</p>
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">OCR-extracted reports from your patients appear here.</p>
        </div>
      ) : (
            ...
            <Link key={r.id} href={`/doctor/review/${r.id}`} className="block rounded-xl bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 shadow-sm p-4 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{capitalize(humanizeSnake(r.report_type || 'report'))}</p>
                </div>
