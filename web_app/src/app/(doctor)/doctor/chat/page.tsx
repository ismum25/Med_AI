...
export default function DoctorChat() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center px-6">
      ...
      <h2 className="text-xl font-bold text-gray-900 mb-2">AI chat is available for patients only.</h2>
      <p className="text-sm text-gray-500 mb-6">Current account: DOCTOR</p>
