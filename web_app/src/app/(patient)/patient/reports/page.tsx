    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {reports.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 mb-1">No reports yet</p>
          <p className="text-sm text-gray-400 dark:text-gray-500 mb-4">Upload your medical reports for AI-powered analysis</p>
        ...
        <div className="space-y-3">
          {reports.map((r) => (
            <Link key={r.id} href={`/patient/reports/${r.id}`} className="block rounded-xl bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 shadow-sm p-4 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{humanizeSnake(r.report_type)} • {formatDate(r.created_at)}</p>
                </div>
