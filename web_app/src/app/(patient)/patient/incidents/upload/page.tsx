...
export default function UploadIncident() {
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Upload Incident</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div
          ...
          className={`relative border-2 border-dashed rounded-2xl h-48 flex flex-col items-center justify-center cursor-pointer transition-colors ${
            file ? 'border-primary-400 bg-primary-50 dark:bg-primary-900/30/50' : 'border-gray-300 hover:border-primary-400'
          }`}
        >
          {preview ? (
          ...
          <div className="relative z-10 text-center">
            {file ? (
              <>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Click or drag to replace</p>
              </>
            ) : (
              <>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-2">Click or drag an injury photo</p>
              </>
            )}
          </div>
